...
@WebServlet(urlPatterns = {"/all_accepted_papers"})
public class all_accepted_papers extends HttpServlet {
...
//                ResultSet rs=stmt.executeQuery("select * from conference_papers");
                ResultSet rs2=stmt2.executeQuery("select paper_id, count(paper_id)\n" +
                                                "from review_report where recomendation = 'accept'\n" +
                                                "    group by paper_id ");
                ...
                "</style>"
                        ...
                        "  <br><br><h2>All Accepted Conference Papers</h2>"+
                        "  <p> </p>\n" +
                        "  <table class=\"table\">\n" +
                ...
                while(rs2.next()){
                    ...
                    if(rs2.getInt(2)>=2){
                        ...
                        ResultSet rs=stmt.executeQuery("select * from conference_papers where paper_id="+rs2.getString(1));
