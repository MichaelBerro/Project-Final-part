...
@WebServlet(urlPatterns = {"/most_reviewed"})
public class most_reviewed extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{  
                ...
                ResultSet rs1=stmt1.executeQuery("select id,MAX(counted) FROM\n" +
                                                "(\n" +
                                                "    SELECT pc_id as id,COUNT(*) AS counted\n" +
                                                "    FROM review_report group by\n" +
                                                "    pc_id\n" +
                                                ") AS counts;");
                ...
                out.println("<!DOCTYPE html>\n" +
                        ...
                        "<body>\n" +
                        "\n" +
                        "<div class=\"container\">\n<br><a href = \"no_paper_reviewed\" ><button type=\"button\" class=\"btn btn-primary\">PC Member with NO paper under review</button></a>\n"
                        ...
                        "  <br><br><h2>Most paper reviewed by</h2>"+
                        "<div class=\"topnav\">\n" +
...
//                        "        <th>Designation</th>\n" +
                ...
                while(rs1.next()){
                    ...
                    ResultSet rs=stmt.executeQuery("select * from pc_members where pc_id="+rs1.getString(1));
